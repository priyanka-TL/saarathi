...
describe('RegisterPage', () => {
  it('sends an OTP, then creates the account and shows success', async () => {
    ...
    await user.type(screen.getByLabelText('Phone number'), '9995385076');
    await user.click(screen.getByRole('button', { name: 'Send OTP' }));

    expect(sendRegistrationOtp).toHaveBeenCalledWith({ phone: '9995385076', phone_code: '+91' });
    ...
    expect(register).toHaveBeenCalledWith({
      phone: '9995385076', phone_code: '+91', otp: '654321', name: 'Asha', password: undefined,
    });
  });
